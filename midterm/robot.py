...
def draw_win_line(device, win_type, win_index):
    ...
    if win_type == 'row':
        ...
        start_y = origin_y + grid_size - line_offset  # Inverted start
        end_x = origin_x + grid_size - line_offset
        end_y = origin_y + line_offset  # Inverted end
        
        device.move_to(x=start_x, y=start_y, z=safe_height, mode=MODE_PTP.MOVJ_XYZ)
        device.move_to(x=start_x, y=start_y, z=drawing_height, mode=MODE_PTP.MOVJ_XYZ)
        device.move_to(x=end_x, y=end_y, z=drawing_height, mode=MODE_PTP.MOVJ_XYZ)
        ...
        start_x = origin_x + grid_size - line_offset
        start_y = origin_y + line_offset  # Top in robot coords
        end_x = origin_x + line_offset
        end_y = origin_y + grid_size - line_offset  # Bottom in robot coords
